...
public class RedisClientTest {
	...
	public static void main(String[] args) {
		...
		RedisTestUtils.getPool().destroy();

	}

	@Test
	public void Hello() {
		Jedis jedis = RedisTestUtils.getJedis();
		try {
			...
			RedisTestUtils.getPool().returnResource(jedis);
		}
	...
	public void testHash() {
		...
		try {
			...
			pairs.put("name", "Akshi");
			pairs.put("name", "Akshi2");
			pairs.put("age", "2");
			pairs.put("sex", "Female");
			jedis.hmset("kid", pairs);
			
			
			Map<String, String> testKidMap = jedis.hgetAll("kid");
			GsonUtils.print(testKidMap);
	...
	public void testSort1() {
		...
		Jedis redis = RedisTestUtils.getJedis();
		...
		redis.flushDB();
		RedisTestUtils.closeJedis(redis);
	}
...
//		sortingParameters.get("#");
	...
	public void testSort5() {
		...
		jedis.flushDB();
		RedisTestUtils.closeJedis(jedis);
	}
